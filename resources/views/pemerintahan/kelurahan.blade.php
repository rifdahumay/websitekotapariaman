    ...
    <div class="breadcrumb-container d-flex align-items-center mb-4 bg-light p-3 rounded shadow-sm">
        <nav aria-label="breadcrumb" class="flex-grow-1">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('pemerintahan.kelurahan') }}" class="text-primary">
                        <i class="bi bi-building"></i> Pemerintahan
                    </a>
                </li>
                <li class="breadcrumb-item active text-dark" aria-current="page">
                    <i class="bi bi-geo-fill"></i> Kelurahan
                </li>
            </ol>
        </nav>
    </div>
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="content bg-white shadow rounded p-5">
                <p>
                    Kelurahan adalah pembagian administratif di bawah kecamatan, berperan dalam pelayanan masyarakat
                    dan pelaksanaan kebijakan di tingkat lokal.
                </p>
            </div>
        </div>
    </div>
